...
any arguments. After this succeeds, you can open the "uwpbuild.sln"
...
are managed by the uwpbuild.sln solution file.  Each sub-project is
...
_ssl
    ...
    running UWPbuild\prepare_ssl.bat. This will retrieve the version of
...
_tkinter
    ...
    UWPbuild\prepare_tcltk.bat. This will retrieve the version of the
...
The UWPbuild solution makes use of Visual Studio property files (*.props)
